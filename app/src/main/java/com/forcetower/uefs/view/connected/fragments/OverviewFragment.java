...
public class OverviewFragment extends androidx.fragment.app.Fragment implements Injectable {
    @BindView(R.id.pb_loading)
    ProgressBar pbLoading;
    @BindView(R.id.draft_card)
    androidx.cardview.widget.CardView draftCard;
    ...
    androidx.cardview.widget.CardView cvClasses;
