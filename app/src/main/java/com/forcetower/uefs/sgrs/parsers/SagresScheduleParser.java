...
public class SagresScheduleParser {
    ...
    public synchronized static List<DisciplineClassLocation> getSchedule(@NonNull Document document, String st1, String st2) {
    ...
    private synchronized static List<DisciplineClassLocation> convertToNewType(HashMap<String, List<SagresClassDay>> hashMap) {
    ...
    private static class SagresClass {
        ...
        synchronized void addClazz(String aClass) {
            aClass = aClass.trim();
