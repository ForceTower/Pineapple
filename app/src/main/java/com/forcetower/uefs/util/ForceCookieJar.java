...
public class ForceCookieJar implements CookieJar {
    private final CookieHandler cookieHandler;

    public ForceCookieJar(CookieHandler cookieHandler) {
    ...
    public void saveFromResponse(@NonNull HttpUrl url, @NonNull List<Cookie> cookies) {
        if (cookieHandler != null) {
            ...
            try {
                ...
                e.printStackTrace();
                //Internal.instance.log(WARNING, "Saving cookies failed for " + url.resolve("/..."), e);
            }
        }
    }
